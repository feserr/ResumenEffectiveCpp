...
\subsection{Item 16: Use the same form in corresponding uses of \texttt{new} 
and \texttt{delete}}
\label{sec:item16}

\begin{frame}
\frametitle{Item 16: Use the same form in corresponding uses of \texttt{new} 
and \texttt{delete}}
\begin{itemize}
...
\subsection{Item 17: Store \texttt{new}ed objects in smart pointers in 
standalone statements}
\label{sec:item17}

\begin{frame}[allowframebreaks]
\frametitle{Item 17: Store \texttt{new}ed objects in smart pointers in 
  standalone statements}
\begin{itemize}
