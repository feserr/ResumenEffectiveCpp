...
you do not want}
\begin{itemize}
  \item Si no queremos que se hagan copias de nuestros objetos, debemos declarar los métodos
  \textbf{copy constructor} y \textbf{copy assigment operator} privados, de este modo el error saldrá
  ...
  \end{minipage}
  De este modo, el objeto que no queramos que sea copiado, haremos que herede de forma privada
  del objeto anterior.
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item Es probable que sin darnos cuentas hagamos un \textbf{self assigment}, por ejemplo:
