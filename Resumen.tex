...
you do not want}
\begin{itemize}
  \item Si no queremos que se hagan copias de nuestros objectos, debemos declarar los métodos
  ...
  \end{minipage}
  De este modo, el objecto que no queramos que sea copiado, haremos que herede de forma privada
  del objecto anterior.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    implicitas o conversiones reversas (un puntuero de un objeto base a su
    derivado).
  \end{itemize}
